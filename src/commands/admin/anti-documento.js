...
module.exports = {
    name: "anti-documento",
    description: "Ativa/Desativa o recurso de anti-documento no grupo.",
    commands: ["anti-documento", "anti-document", "anti-doc"],
    usage: `${PREFIX}anti-documento (1 / 0)`,
    handle: async ({
        remoteJid,
        isGroup,
        args,
        ...
        try {
            ...
            if (!admins.includes(userJid)) {
                return await sendWarningReply(
                    "Apenas administradores podem configurar o anti-documento!"
                );
            }
            ...
            restrictions[remoteJid]["anti-document"] = enable;
            ...
            return await sendSuccessReply(
                `Anti-documento ${status} com sucesso!`
            );
        } catch (error) {
            console.error("Erro no comando anti-documento:", error);
            return await sendErrorReply(
                "Ocorreu um erro ao configurar o anti-documento. Por favor, tente novamente."
            );
        }
    }
};
